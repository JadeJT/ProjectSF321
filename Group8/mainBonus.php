...
$result = mysqli_query($con, "SELECT * FROM register WHERE Type = 'บำนาญ'");
?>
        ...
        <table border="1" style="table-layout: fixed;">
          ...
          <!--Use a while loop to make a table row for every DB row-->
            ...
            <tr>
              ...
              <td><center><a href="requestBonus.php?id='<?php echo $row['id']?>'"><button>รายละเอียด</button></a></center></td>
            </tr>
            <?php endwhile ?>
          </tbody>
        </table>
