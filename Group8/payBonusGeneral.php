...
$result = mysqli_query($con, "SELECT register.*, bonus.Status FROM register LEFT JOIN bonus ON register.IDcard = bonus.IDcard WHERE register.Career != 'ครู' AND register.Type = 'บำนาญ' AND bonus.Month = $month AND bonus.Year = $year ");
?>
...
<center>
  <br><br>
  <form action="payBonusGeneral.php" method="post">
    <select name="Month">
